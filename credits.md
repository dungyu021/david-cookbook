...
料理宇宙(`/universe/`)使用的食材 3D 模型來源。之後會依這份清單做一個網站上的致謝頁,感謝以下作者。

## 模型包

- **Food Kit** — https://kenney.nl/assets/food-kit
  作者:Kenney — https://kenney.nl/ — 授權:CC0(Kenney 的素材一律公眾領域,不強制標明出處)
...
- **Peanut**(`nut.glb`)— https://poly.pizza/m/f57FFcX01Tr
  作者:jeremy — 授權:[CC-BY 3.0](https://creativecommons.org/licenses/by/3.0/)(透過 Poly Pizza)

- **Butter**(`butter.glb`)— https://poly.pizza/m/0AsP8A3zktZ
  作者:Jarlan Perez — 授權:[CC-BY 3.0](https://creativecommons.org/licenses/by/3.0/)(透過 Poly Pizza)

- **A cup of rosemary**(`rosemary.glb`,用來代表巴西里)— https://poly.pizza/m/1YLqlRbgskh
  作者:Mikael Ganehag Brorsson — 授權:[CC-BY 3.0](https://creativecommons.org/licenses/by/3.0/)(透過 Poly Pizza)

- **Spaghetti Bowl**(`spaghetti.glb`)— https://poly.pizza/m/00zv9o-Gjo2
  作者:Jarlan Perez — 授權:[CC-BY 3.0](https://creativecommons.org/licenses/by/3.0/)(透過 Poly Pizza)
